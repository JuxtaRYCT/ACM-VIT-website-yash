...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  examcooker: {
    ...
    status: "online",
    statusNote: "Actively maintained",
    heroImage: "/projects/examcooker/projects-examcooker-logo.webp",
    gallery: [
  ...
  localhost: {
    ...
    gallery: [
      { src: "/projects/localhost/projects-localhost-screen-1.webp", alt: "Localhost VS Code-styled portal" },
      { src: "/projects/localhost/projects-localhost-screen-2.webp", alt: "Localhost editor view" },
      { src: "/projects/localhost/projects-localhost-screen-3.webp", alt: "Localhost markdown content" },
      { src: "/projects/localhost/projects-localhost-screen-4.webp", alt: "Localhost form round" },
      { src: "/projects/localhost/projects-localhost-screen-5.webp", alt: "Localhost terminal pane" },
      { src: "/projects/localhost/projects-localhost-screen-6.webp", alt: "Localhost portal flow" },
    ],
    galleryLayout: "landscape",
    stats: [
  ...
  "ocs-25": {
    ...
    gallery: [
      { src: "/projects/ocs-25/projects-ocs-25-screen-1.webp", alt: "OS desktop" },
      { src: "/projects/ocs-25/projects-ocs-25-screen-2.webp", alt: "OS app window" },
      { src: "/projects/ocs-25/projects-ocs-25-screen-3.webp", alt: "OS domain app" },
      { src: "/projects/ocs-25/projects-ocs-25-screen-4.webp", alt: "OS terminal / scheduler" },
      { src: "/projects/ocs-25/projects-ocs-25-screen-5.webp", alt: "OS game view" },
      { src: "/projects/ocs-25/projects-ocs-25-screen-6.webp", alt: "OS settings / wallpaper" },
    ],
    galleryLayout: "landscape",
    stats: [
  ...
  "ocs-26": {
    ...
    cassetteSvg: "/projects/cassettes/projects-cassettes-ocs-26.webp",
    gallery: [
      { src: "/projects/ocs-26/projects-ocs-26-screen-1.webp", alt: "Explore browser-themed portal" },
      { src: "/projects/ocs-26/projects-ocs-26-screen-2.webp", alt: "Explore browser tabs and content" },
      { src: "/projects/ocs-26/projects-ocs-26-screen-3.webp", alt: "Explore form-as-webpage round" },
      { src: "/projects/ocs-26/projects-ocs-26-screen-4.webp", alt: "Explore in-house meeting client" },
      { src: "/projects/ocs-26/projects-ocs-26-screen-5.webp", alt: "Explore game inside browser" },
      { src: "/projects/ocs-26/projects-ocs-26-screen-6.webp", alt: "Explore portal flow" },
    ],
    galleryLayout: "landscape",
    stats: [
  ...
  "ocs-22": {
    ...
    gallery: [
      { src: "/projects/ocs-22/projects-ocs-22-screen-1.webp", alt: "OCS '22 in-game scene" },
      { src: "/projects/ocs-22/projects-ocs-22-screen-2.webp", alt: "OCS '22 in-game scene" },
      { src: "/projects/ocs-22/projects-ocs-22-screen-3.webp", alt: "OCS '22 in-game scene" },
      { src: "/projects/ocs-22/projects-ocs-22-screen-4.webp", alt: "OCS '22 in-game scene" },
    ],
    galleryLayout: "landscape",
    stats: [
  ...
  "ocs-23": {
    ...
    gallery: [
      { src: "/projects/ocs-23/projects-ocs-23-frame-10.webp", alt: "OCS '23 terminal interface" },
      { src: "/projects/ocs-23/projects-ocs-23-frame-11.webp", alt: "OCS '23 terminal interface" },
      { src: "/projects/ocs-23/projects-ocs-23-frame-12.webp", alt: "OCS '23 terminal interface" },
    ],
    galleryLayout: "landscape",
    stats: [
  ...
  "cli-rpg": {
    ...
    gallery: [
      { src: "/projects/cli-rpg/projects-cli-rpg-shot-login.webp", alt: "CLI-RPG login screen" },
      { src: "/projects/cli-rpg/projects-cli-rpg-shot-house.webp", alt: "CLI-RPG haunted house ASCII art" },
      { src: "/projects/cli-rpg/projects-cli-rpg-shot-map.webp", alt: "CLI-RPG floor plan exploration" },
      { src: "/projects/cli-rpg/projects-cli-rpg-shot-puzzle.webp", alt: "CLI-RPG DNA sequence puzzle" },
    ],
    galleryLayout: "landscape",
    stats: [
